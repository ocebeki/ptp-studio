    ...
    <div class="container column">
        <div class=gallery__wrapper>
                ...
                $count = 0;
                 while ( have_rows('filters') ) : the_row(); ?>
                    <div class="gallery__filter <?php 
                     if (!$count) { ?>gallery__filter--active<?php }?>"
                        data-filter="<?php the_sub_field('category'); ?>">
            ...
            <div class="gallery__grid-wrapper gallery__grid-wrapper--grid" id="lightgallery">
                ...
                <?php $klasy = get_sub_field('klasa'); ?>
                <a class="gallery__image-wrapper gallery__grid-sizer-sm <?php if( get_sub_field('klasa') ) : foreach( $klasy as $klasa ): echo $klasa . ' '; endforeach; endif; ?> "
