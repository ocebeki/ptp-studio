        ...
        <div class=gallery__wrapper>
            <div class="gallery__text-wrapper">
                ...
                <div class="gallery__filters-wrapper">
                    <div class="gallery__filter gallery__filter--active">WSZYSTKIE</div>
                    <div class='gallery__separator'>/</div>
                    <div class="gallery__filter">ARCHITEKTURA</div>
                    <div class='gallery__separator'>/</div>
                    <div class="gallery__filter">PORTRETY</div>
                    <div class='gallery__separator'>/</div>
                    <div class="gallery__filter">SPORT</div>
                    <div class='gallery__separator'>/</div>
                    <div class="gallery__filter">PACK-SHOT</div>
                </div>
            </div>
            <div class="gallery__grid-wrapper gallery__grid-wrapper--grid">
                ...
                <a class="gallery__image-wrapper" href=<?php the_sub_field('image'); ?> data-lightbox="gallery"
                    data-title="fot. Paweł Tichoniuk">
